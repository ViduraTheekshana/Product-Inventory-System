...
check log - docker compose logs -f app

### To project stop

cmd - docker compose down ( -v for wipe off the entire database )

### To access the database

docker exec -it product-inventory-service-postgres-1 psql -U inventory_user -d inventory_db -c "SELECT * FROM products;"
